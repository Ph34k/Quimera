...
def is_safe_url(url: str) -> bool:
    try:
        ...
        for result in addr_info:
            ...
            if ip_obj.is_private or ip_obj.is_loopback or ip_obj.is_multicast or ip_obj.is_link_local or ip_obj.is_reserved or ip_obj.is_unspecified:
                return False
        return True
    except Exception:
        return False
...
def verify_request(request: 'httpx.Request'):
    if not is_safe_url(str(request.url)):
        raise ValueError("URL rejected due to SSRF protection")
