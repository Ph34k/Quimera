...
# ⚡ Bolt Optimization: Reusable persistent client for HTTP connection pooling
# Impact: Avoids the latency overhead of establishing a new TCP/TLS connection for every agent request.
