    ...
    def execute(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not _is_safe_url(target_url):
            return {
                ...
                "target": target_url,
                "error": "Target URL is not safe or resolves to an internal/private IP."
            }
...
class IExecutionAgent(BaseAgent):
    ...
    def execute(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not _is_safe_url(target_url):
            return {"status": "execution_failed", "error": "Target URL is not safe or resolves to an internal/private IP."}
