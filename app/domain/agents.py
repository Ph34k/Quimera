...
class IScoutAgent(BaseAgent):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # ⚡ Bolt: Persistent HTTP client for connection pooling
...
class IExecutionAgent(BaseAgent):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # ⚡ Bolt: Persistent HTTP client for connection pooling with stealth headers
        headers = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"}
        self.client = httpx.Client(headers=headers, timeout=5.0, follow_redirects=True)
