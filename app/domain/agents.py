...
def _is_safe_url(url: str) -> bool:
    """Security check to prevent SSRF by validating the target URL."""
    try:
        parsed = urlparse(url)
...
class IScoutAgent(BaseAgent):
    ...
    def execute(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # SECURITY: Validate URL to prevent SSRF against internal network
        ...
        try:
            ...
            # SECURITY: follow_redirects=False prevents SSRF bypass via redirects
