...
# ⚡ Bolt: Use a persistent HTTPx client to enable connection pooling.
# This prevents the overhead of creating a new connection for every request,
# resulting in significantly faster API calls compared to httpx.get()
