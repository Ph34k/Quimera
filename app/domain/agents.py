...
class IScoutAgent(BaseAgent):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # ⚡ Bolt: Use persistent httpx.Client for connection pooling to eliminate TCP/TLS handshake overhead on repeated executes.
...
class IExecutionAgent(BaseAgent):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # ⚡ Bolt: Persistent HTTP connection pool to boost performance for stealth web driving requests.
